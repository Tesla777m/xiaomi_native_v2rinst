...
unpack_ipk "v2ray-core_5.30.0-r1_aarch64_generic.ipk" "$USB_DIR/v2rayA-native/v2ray-core"
unpack_ipk "v2raya_2.2.7.3-r1_aarch64_generic.ipk" "$USB_DIR/v2rayA-native/v2raya"
unpack_ipk "v2ray-geoip_202510050144-r1_all.ipk" "$USB_DIR/v2rayA-native/v2ray-geoip"
unpack_ipk "v2ray-geosite_20250916122507-r1_all.ipk" "$USB_DIR/v2rayA-native/v2ray-geosite"
